...
elseif(CARES_INCLUDE_DIR)
  if(EXISTS "${CARES_INCLUDE_DIR}/ares_version.h")
    file(STRINGS "${CARES_INCLUDE_DIR}/ares_version.h" _version_str REGEX "#[\t ]*define[\t ]+ARES_VERSION_STR[\t ]+\"(.*)\"")
    string(REGEX REPLACE "^.*\"([^\"]+)\"" "\\1" CARES_VERSION "${_version_str}")
    unset(_version_str)
  else()
    set(CARES_VERSION "0.0")
  endif()
endif()
