...
elseif(NGTCP2_INCLUDE_DIR)
  if(EXISTS "${NGTCP2_INCLUDE_DIR}/ngtcp2/version.h")
    file(STRINGS "${NGTCP2_INCLUDE_DIR}/ngtcp2/version.h" _version_str REGEX "#[\t ]*define[\t ]+NGTCP2_VERSION[\t ]+\"(.*)\"")
    string(REGEX REPLACE "^.*\"([^\"]+)\"" "\\1" NGTCP2_VERSION "${_version_str}")
    unset(_version_str)
  else()
    set(NGTCP2_VERSION "0.0")
  endif()
endif()
