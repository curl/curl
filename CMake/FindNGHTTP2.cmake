...
elseif(NGHTTP2_INCLUDE_DIR)
  if(EXISTS "${NGHTTP2_INCLUDE_DIR}/nghttp2/nghttp2ver.h")
    file(STRINGS "${NGHTTP2_INCLUDE_DIR}/nghttp2/nghttp2ver.h" _version_str REGEX "#[\t ]*define[\t ]+NGHTTP2_VERSION[\t ]+\"(.*)\"")
    string(REGEX REPLACE "^.*\"([^\"]+)\"" "\\1" NGHTTP2_VERSION "${_version_str}")
    unset(_version_str)
  else()
    set(NGHTTP2_VERSION "0.0")
  endif()
endif()
