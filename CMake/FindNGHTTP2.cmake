...
elseif(nghttp2_CONFIG)
  ...
  if(NGHTTP2_USE_STATIC_LIBS)
    set(_curl_use_target nghttp2::nghttp2_static)
  else()
    set(_curl_use_target nghttp2::nghttp2)
  endif()
  add_library(CURL::nghttp2 INTERFACE IMPORTED)
  set_target_properties(CURL::nghttp2 PROPERTIES INTERFACE_LINK_LIBRARIES "${_curl_use_target}")
