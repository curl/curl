...
elseif(Zstd_CONFIG)
  ...
  if(ZSTD_USE_STATIC_LIBS)
    set(_curl_use_target zstd::libzstd_static)
  else()
    set(_curl_use_target zstd::libzstd)
  endif()
  add_library(CURL::zstd INTERFACE IMPORTED)
  set_target_properties(CURL::zstd PROPERTIES INTERFACE_LINK_LIBRARIES "${_curl_use_target}")
