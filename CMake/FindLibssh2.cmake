...
elseif(libssh2_CONFIG)
  ...
  if(LIBSSH2_USE_STATIC_LIBS)
    set(_curl_use_target libssh2::libssh2_static)
  else()
    set(_curl_use_target libssh2::libssh2)
  endif()
  get_target_property(_curl_original_target ${_curl_use_target} ALIASED_TARGET)
  if(_curl_original_target)
    set(_curl_use_target ${_curl_original_target})
  endif()
  add_library(CURL::libssh2 INTERFACE IMPORTED)
  set_target_properties(CURL::libssh2 PROPERTIES INTERFACE_LINK_LIBRARIES "${_curl_use_target}")
