...
elseif(libssh2_CONFIG)
  ...
  if(LIBSSH2_USE_STATIC_LIBS)
    add_library(CURL::libssh2 ALIAS libssh2::libssh2_static)
  else()
    get_target_property(_curl_original_target libssh2::libssh2 ALIASED_TARGET)
    if(_curl_original_target)
      add_library(CURL::libssh2 ALIAS ${_curl_original_target})
    else()
      add_library(CURL::libssh2 ALIAS libssh2::libssh2)
    endif()
  endif()
