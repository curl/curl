...
if(LIBUV_FOUND)
  ...
  if(LIBUV_INCLUDE_DIR)
    if(EXISTS "${LIBUV_INCLUDE_DIR}/uv/version.h")
      file(STRINGS "${LIBUV_INCLUDE_DIR}/uv/version.h" _libuv_header)
      string(REGEX MATCH ".*define UV_VERSION_MAJOR *([0-9]+).*define UV_VERSION_MINOR *([0-9]+).*define UV_VERSION_PATCH *([0-9]+)" _libuv_ver "${_libuv_header}")
