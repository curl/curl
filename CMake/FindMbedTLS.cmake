...
elseif(MBEDTLS_INCLUDE_DIR)
  if(EXISTS "${MBEDTLS_INCLUDE_DIR}/mbedtls/build_info.h")
    file(READ "${MBEDTLS_INCLUDE_DIR}/mbedtls/build_info.h" _version_header_new)
  endif()
  file(READ "${MBEDTLS_INCLUDE_DIR}/mbedtls/version.h" _version_header_old)
  set(_version_regex "MBEDTLS_VERSION_STRING[\t ]+\"([0-9.]+)\"")
  string(REGEX MATCH "${_version_regex}" _version_match "${_version_header_new} ${_version_header_old}")
  string(REGEX REPLACE "${_version_regex}" "\\1" MBEDTLS_VERSION "${_version_match}")
  unset(_version_header_new)
  unset(_version_header_old)
