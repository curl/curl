...
# Convert the passed paths to libpath linker options and add them to CMAKE_REQUIRED_* option.
macro(curl_required_libpaths _libpaths)
  if(CMAKE_VERSION VERSION_LESS 3.31)
    set(_local_libpaths "${_libpaths}")
    foreach(_libpath IN LISTS _local_libpaths)
      list(APPEND CMAKE_REQUIRED_LINK_OPTIONS "${CMAKE_LIBRARY_PATH_FLAG}${_libpath}")
    endforeach()
  else()
    list(APPEND CMAKE_REQUIRED_LINK_DIRECTORIES "${_libpaths}")
  endif()
endmacro()
