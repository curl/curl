...
macro(curl_add_clang_tidy_test_target _target_clang_tidy _target)
  if(CURL_CLANG_TIDY)
    ...
    foreach(_inc IN LISTS _incsys_tmp)
      # Avoid empty and '$<INSTALL_INTERFACE:include>' items. The latter also evaluates to an
      # empty path in this context. Also skip '$<BUILD_INTERFACE:curl-include>' which is a duplicate.
      if(_inc AND NOT _inc MATCHES "INSTALL_INTERFACE:" AND NOT _inc MATCHES "BUILD_INTERFACE:")
