...
if(GSASL_FOUND)
  ...
  if(GSASL_INCLUDE_DIR)
    if(EXISTS "${GSASL_INCLUDE_DIR}/gsasl-version.h")
      file(STRINGS "${GSASL_INCLUDE_DIR}/gsasl-version.h" _version_header)
      string(REGEX MATCH "#[\t ]*define[\t ]+GSASL_VERSION[\t ]+\"(.*)\"" _version_match "${_version_header}")
      set(GSASL_VERSION "${CMAKE_MATCH_1}")
