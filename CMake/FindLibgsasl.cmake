...
if(LIBGSASL_FOUND)
  ...
  if(LIBGSASL_INCLUDE_DIR)
    if(EXISTS "${LIBGSASL_INCLUDE_DIR}/gsasl-version.h")
    ...
    if(NOT EXISTS "${LIBGSASL_INCLUDE_DIR}")
      message(WARNING "LIBGSASL_INCLUDE_DIR directory not found: ${LIBGSASL_INCLUDE_DIR}")
    endif()
  endif()
