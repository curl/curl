...
if(LIBIDN2_FOUND)
  ...
  if(LIBIDN2_INCLUDE_DIR)
    if(EXISTS "${LIBIDN2_INCLUDE_DIR}/idn2.h")
      file(STRINGS "${LIBIDN2_INCLUDE_DIR}/idn2.h" _version_header)
      string(REGEX MATCH "#[\t ]*define[\t ]+IDN2_VERSION[\t ]+\"(.*)\"" _version_match "${_version_header}")
      set(LIBIDN2_VERSION "${CMAKE_MATCH_1}")
