...
if(NOT LDAP_FOUND)
  check_library_exists("ldap" "ldap_init" "" HAVE_LIBLDAP)
  if(HAVE_LIBLDAP)
    check_library_exists("ldap;lber" "ber_init" "" HAVE_LIBLBER)
  else()
    check_library_exists("lber" "ber_init" "" HAVE_LIBLBER)
  endif()
  ...
  if(HAVE_LDAP_H AND HAVE_LIBLDAP)
    set(LDAP_FOUND ON)
