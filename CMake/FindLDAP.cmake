...
if(NOT LDAP_FOUND)
  check_library_exists("ldap" "ldap_init" "" _have_libldap)
  if(_have_libldap)
    check_library_exists("ldap;lber" "ber_init" "" _have_liblber)
  else()
    check_library_exists("lber" "ber_init" "" _have_liblber)
  endif()

  unset(_include_list)
  check_include_file("lber.h" _have_lber_h)
  if(_have_lber_h)
    list(APPEND _include_list "lber.h")
  endif()
  check_include_files("${_include_list};ldap.h" _have_ldap_h)
  unset(_include_list)

  if(_have_ldap_h AND _have_libldap)
    set(LDAP_FOUND ON)
    unset(LDAP_LIBRARIES)
    if(_have_liblber)
      set(LDAP_LIBRARIES "lber")
    endif()
    list(APPEND LDAP_LIBRARIES "ldap")
  endif()
endif()
