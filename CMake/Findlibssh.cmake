...
if(LIBSSH_FOUND)
  ...
  if(LIBSSH_INCLUDE_DIR)
    if(EXISTS "${LIBSSH_INCLUDE_DIR}/libssh/libssh_version.h")
      file(STRINGS "${LIBSSH_INCLUDE_DIR}/libssh/libssh_version.h" _version_header)
      string(REGEX MATCH ".*define LIBSSH_VERSION_MAJOR *([0-9]+).*define LIBSSH_VERSION_MINOR *([0-9]+).*define LIBSSH_VERSION_MICRO *([0-9]+)" _version_match "${_version_header}")
