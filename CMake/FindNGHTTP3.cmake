...
elseif(nghttp3_CONFIG)
  ...
  if(NGHTTP3_USE_STATIC_LIBS)
    set(_curl_use_target nghttp3::nghttp3_static)
  else()
    set(_curl_use_target nghttp3::nghttp3)
  endif()
  add_library(CURL::nghttp3 INTERFACE IMPORTED)
  set_target_properties(CURL::nghttp3 PROPERTIES INTERFACE_LINK_LIBRARIES "${_curl_use_target}")
