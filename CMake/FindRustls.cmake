...
elseif(NOT WIN32)
  find_library(_pthread_library NAMES "pthread")
  if(_pthread_library)
    list(APPEND RUSTLS_LIBRARIES ${_pthread_library})
  endif()
  mark_as_advanced(_pthread_library)

  find_library(_dl_library NAMES "dl")
  if(_dl_library)
    list(APPEND RUSTLS_LIBRARIES ${_dl_library})
  endif()
  mark_as_advanced(_dl_library)

  find_library(_math_library NAMES "m")
  if(_math_library)
    list(APPEND RUSTLS_LIBRARIES ${_math_library})
  endif()
