...
sub testcompile {
    my $rc = system("gcc -c test.c -DCURL_ALLOW_OLD_MULTI_SOCKET -DCURL_DISABLE_DEPRECATION -Wunused -Werror -Wall -Weverything -Wno-unused-but-set-variable -I include") >> 8;
    return $rc;
}
