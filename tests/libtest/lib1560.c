...
static const struct urltestcase get_url_list[] = {
  {"http://example.com?one=a%26a&two=bb",
   "http://example.com/?one=a%26a&two=bb",
   0, CURLU_NO_DEFAULT_PORT|CURLU_NORMALIZE, CURLUE_OK},
  ...
  {"http://US%45R,:us%45r,@example.com:80/~smith/home.html#%2b",
   ...
   0, CURLU_NO_DEFAULT_PORT|CURLU_NORMALIZE, CURLUE_OK},
  {"http://US%45R,:us%45r,@example.com:80/~smith/home.html#%2b",
   "http://US%45R,:us%45r,@example.com/~smith/home.html#%2b",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://example.com:80/~smith/home.html#%2b",
   "http://example.com/~smith/home.html#%2B",
   0, CURLU_NO_DEFAULT_PORT|CURLU_NORMALIZE, CURLUE_OK},
  {"http://example.com:80/~smith/home.html#%2b",
   "http://example.com/~smith/home.html#%2b",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://%45XAMPLE.COM:80/~smith/home.html",
   "http://example.com/~smith/home.html",
   0, CURLU_NO_DEFAULT_PORT|CURLU_NORMALIZE, CURLUE_OK},
  {"http://%45XAMPLE.COM:80/~smith/home.html",
   "http://EXAMPLE.COM:80/~smith/home.html",
   0, 0, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2F/home.html",
   "http://example.com/~smith%2F/home.html",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2F/home.html",
   "http://EXAMPLE.COM/%7esmith%2F/home.html",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2f/home.html",
   "http://example.com/~smith%2F/home.html",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2f/home.html",
   "http://EXAMPLE.COM/%7esmith%2f/home.html",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2f/?%61#%41",
   "http://example.com/~smith%2F/?a#A",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  {"http://EXAMPLE.COM:80/%7esmith%2f/?%61#%41",
   "http://EXAMPLE.COM/%7esmith%2f/?%61#%41",
   0, CURLU_NO_DEFAULT_PORT, CURLUE_OK},
  ...
  {"https://%41", "https://a/", 0, CURLU_NORMALIZE, CURLUE_OK},
  {"https://%41", "https://A/", 0, 0, CURLUE_OK},
  {"https://%61", "https://a/", 0, CURLU_NORMALIZE, CURLUE_OK},
  {"https://%61", "https://a/", 0, 0, CURLUE_OK},
  ...
  {"http://HO0_-st..~./", "http://ho0_-st..~./",
   0, CURLU_NORMALIZE, CURLUE_OK},
  {"http://HO0_-st..~./", "http://HO0_-st..~./",
   0, 0, CURLUE_OK},
  ...
  {"imap://user:pass;w%6frd@host/file",
  ...
  {"http://user:pass;word@host/file",
   "http://user:pass%3Bword@host/file",
   0, CURLU_NORMALIZE, CURLUE_OK},
  {"http://user:pass;word@host/file",
  ...
  {"http://user:password@example.com:1234/path/html?"
   "query=name&foo=bar;b%61r=foo#%61nchor",
   "http://user:password@example.com:1234/path/html?"
   "query=name&foo=bar;bar=foo#anchor",
   0, CURLU_NORMALIZE, CURLUE_OK},
  {"http://user:password@example.com:1234/path/html?"
   "query=name&foo=bar;b%61r=foo#%61nchor",
   "http://user:password@example.com:1234/path/html?"
...
static const struct setcase set_parts_list[] = {
  ...
  {"https://example.com/",
   ...
   0, 0, 0, CURLUE_OK, CURLUE_OK},
  {"https://example.com/",
   "path=one\rtwo,",
   "https://example.com/one%0Dtwo",
   0, 0, CURLU_NORMALIZE, CURLUE_OK, CURLUE_OK},
  {"https://example.com/",
   "path=one\ntwo,",
  ...
  {"https://example.com/",
   "path=one\ntwo,",
   "https://example.com/one%0Atwo",
   0, CURLU_URLENCODE, 0, CURLUE_OK, CURLUE_OK},
  {"https://example.com/",
   "path=one\rtwo,",
   "https://example.com/one%0Dtwo",
   0, CURLU_URLENCODE, 0, CURLUE_OK, CURLUE_OK},
  ...
  {"https://example.com/",
   "host=%25url.se,",
   "",
   0, 0, 0, CURLUE_OK, CURLUE_BAD_HOSTNAME},
  {"https://example.com/?param=value",
   "query=\"\",",
   "https://example.com/",
   0, CURLU_APPENDQUERY | CURLU_URLENCODE, 0, CURLUE_OK, CURLUE_OK},
  {"https://example.com/",
   "host=\"\",",
   "https://example.com/",
   0, CURLU_URLENCODE, 0, CURLUE_OK, CURLUE_BAD_HOSTNAME},
  {"https://example.com/",
   "host=\"\",",
   "https://example.com/",
   0, 0, 0, CURLUE_OK, CURLUE_BAD_HOSTNAME},
  ...
  {"https://example.com/",
   "scheme=ftp+-.123,",
   "ftp+-.123://example.com/",
   0, CURLU_NON_SUPPORT_SCHEME, 0, CURLUE_OK, CURLUE_OK},
  {"https://example.com/",
   "scheme=1234,",
   "https://example.com/",
   0, CURLU_NON_SUPPORT_SCHEME, 0, CURLUE_OK, CURLUE_BAD_SCHEME},
  {"https://example.com/",
   "scheme=1http,",
   "https://example.com/",
   0, CURLU_NON_SUPPORT_SCHEME, 0, CURLUE_OK, CURLUE_BAD_SCHEME},
  ...
  {"https://example.com/",
   ...
   0, /* get */
   0, /* set */
   0, CURLUE_OK, CURLUE_BAD_HOSTNAME},
  {"https://example.com/",
   "host=http://fake,",
   "",
   0, /* get */
  ...
  {"https://host:1234/",
   "port=\"\",",
   "https://host:1234/",
   0, 0, 0, CURLUE_OK, CURLUE_BAD_PORT_NUMBER},
  {"https://host:1234/",
   "port=56 78,",
   "https://host:1234/",
   0, 0, 0, CURLUE_OK, CURLUE_BAD_PORT_NUMBER},
  ...
  {"imap://user:secret;opt@host/",
   ...
   0, 0, 0, CURLUE_NO_HOST, CURLUE_OK},
  ...
  {"http://example.com/",
   ...
   "http://example.com/",
   0, 0, 0, CURLUE_OK, CURLUE_UNSUPPORTED_SCHEME},
  {"http://example.com/",
  ...
  {"custom-scheme://host",
   "host=\"\",",
   "custom-scheme://host/",
   CURLU_NON_SUPPORT_SCHEME, CURLU_NON_SUPPORT_SCHEME, 0, CURLUE_OK,
   CURLUE_BAD_HOSTNAME},
  {"custom-scheme://host",
   "host=\"\",",
   "custom-scheme:///",
  ...
  {NULL, NULL, NULL, 0, 0, 0, CURLUE_OK, CURLUE_OK}
};
...
static const struct redircase set_url_list[] = {
  ...
  {"http://example.org?bar/moo#yes/path", "#new/slash",
   "http://example.org/?bar/moo#new%2Fslash", 0, 0, CURLUE_OK},
  {"http://example.org/foo?bar", "#weird",
  ...
  {"http://example.org/foo/bar",
   ":23",
   "http://example.org/foo/%3A23",
   0, 0, CURLUE_OK},
  {"http://example.org/foo/bar",
   "\\x",
   "http://example.org/foo/%5Cx",
   /* WHATWG disagrees */
   0, 0, CURLUE_OK},
  {"http://example.org/foo/bar",
   "#/",
   "http://example.org/foo/bar#%2F",
   0, 0, CURLUE_OK},
  {"http://example.org/foo/bar",
   "?/",
   "http://example.org/foo/bar?/",
  ...
  {"http://example.org/foo/bar",
   "#;?",
   "http://example.org/foo/bar#%3B%3F",
   0, 0, CURLUE_OK},
  {"http://example.org/foo/bar",
   "#",
   "http://example.org/foo/bar",
  ...
  {"http://example.com/please/../gimme/%TESTNUMBER?foobar#hello",
   ...
   "http://example.net/there/tes%20t%20case%3D/%25TESTNUMBER0002?+yes+no",
  ...
  for(i = 0; set_parts_list[i].set && !error; i++) {
    ...
    if(!rc) {
      ...
      if(!uc) {
        ...
        rc = curl_url_get(urlp, CURLUPART_URL, &url,
                          set_parts_list[i].getflags);
