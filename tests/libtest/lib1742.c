...
static CURLcode test_lib1742(const char *URL)
{
  ...
  if(curl_easy_setopt(curl, CURLOPT_SOCKS5_AUTH, (long)CURLAUTH_ONLY) !=
     CURLE_BAD_FUNCTION_ARGUMENT) {
    curl_mfprintf(stderr, "CURLAUTH_ONLY without a method was accepted\n");
