...
CURLcode test(char *URL)
{
  ...
  /* third transfer: set URL + query + extra query in the second CURLU
     handle, but do not set CURLOPT_CURLU again. this is to test that the
     contents of the handle is allowed to change between transfers and is used
     without having to set CURLOPT_CURLU again */
