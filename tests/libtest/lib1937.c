...
FETCHcode test(char *URL)
{
  ...
  test_setopt(fetch, FETCHOPT_AWS_SIGV4, "provider1:provider2:region:service");
  test_setopt(fetch, FETCHOPT_USERPWD, "keyId:SecretKey");
  ...
  test_setopt(fetch, FETCHOPT_POSTFIELDS, "postData");
