...
static int test_rlimit(int keep_open)
{
  ...
  if((rl.rlim_cur > 0) &&
    ...
    rlim2str(strbuff1, sizeof(strbuff1), t518_num_open.rlim_cur);
  ...
  do {
    ...
    rlim2str(strbuff, sizeof(strbuff), t518_num_open.rlim_max);
  ...
  if((size_t)(t518_num_open.rlim_max) > ((size_t)-1) / sizeof(*t518_testfd)) {
    rlim2str(strbuff1, sizeof(strbuff1), t518_num_open.rlim_max);
  ...
  for(t518_num_open.rlim_cur = 1;
    ...
    if(t518_testfd[t518_num_open.rlim_cur] < 0) {
      ...
      rlim2str(strbuff2, sizeof(strbuff2), t518_num_open.rlim_max);
      rlim2str(strbuff1, sizeof(strbuff1), t518_num_open.rlim_cur);
      curl_msnprintf(strbuff, sizeof(strbuff),
