...
script offers a `-e` option that makes it perform _event-based_. Such tests
...
_libuv_ to be present and enabled in the build: `configure --enable-libuv`
...
**_not suitable for production_**, it is often helpful in tracking down
problems.
