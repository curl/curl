...
static CURLcode test_unit1654(const char *arg)
{
  ...
  if(Curl_peer_altsvc_screate("example.org", 8080, &origin))
    goto fail;
  ...
  if(Curl_peer_altsvc_screate("2.example.org", 8080, &origin))
    goto fail;
  ...
  if(Curl_peer_altsvc_screate("3.example.org", 8080, &origin))
    goto fail;
  ...
  if(Curl_peer_altsvc_screate("example.org", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  /* quoted 'ma' value */
  if(Curl_peer_altsvc_screate("example.net", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  if(Curl_peer_altsvc_screate("curl.se", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  if(Curl_peer_altsvc_screate("5.example.net", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  if(Curl_peer_altsvc_screate("6.example.net", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
                             "h2=\"example.net:443,; ma=\"180\";\r\n",
                             ALPN_h2, origin);
  ...
  if(Curl_peer_altsvc_screate("7.example.net", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  if(Curl_peer_altsvc_screate("8.example.net", 80, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
  ...
  if(Curl_peer_altsvc_screate("test.se", 443, &origin))
    goto fail;
  result = Curl_altsvc_parse(curl, asi,
