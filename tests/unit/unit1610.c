...
#if !defined(FETCH_DISABLE_AWS) || !defined(FETCH_DISABLE_DIGEST_AUTH) || defined(USE_LIBSSH2)

const char string1[] = "1";
const char string2[] = "hello-you-fool";
unsigned char output[FETCH_SHA256_DIGEST_LENGTH];
unsigned char *testp = output;

Fetch_sha256it(output, (const unsigned char *)string1, strlen(string1));
...
Fetch_sha256it(output, (const unsigned char *)string2, strlen(string2));
