...
static CURLcode unit_setup(void)
{
  ...
  curl_easy_setopt(t1302_testdata, CURLOPT_DEBUGFUNCTION, debugf_cb);
  curl_easy_setopt(t1302_testdata, CURLOPT_VERBOSE, 1L);
  return res;
}
