#ifndef HEADER_CURL_CONFIG_MQX_H
#define HEADER_CURL_CONFIG_MQX_H
/***************************************************************************
 *                                  _   _ ____  _
 *  Project                     ___| | | |  _ \| |
 *                             / __| | | | |_) | |
...
/* ================================================================ */
/*               Hand crafted config file for MQX RTOS              */
/* ================================================================ */
...
/* Define if getaddrinfo is thread safe. */
...
/* Define to the size of `time_t', as computed by sizeof. */
#define SIZEOF_TIME_T 4

/* Define to use blocking sockets. */
#define USE_BLOCKING_SOCKETS

/* Define time_t unsigned */
#undef HAVE_TIME_T_UNSIGNED

/* Define to use wolfSSL */
#define USE_WOLFSSL

/* Define to use SHA256-function from OpenSSL */
#define USE_OPENSSL_SHA256

/* Define to enable HTTP only. */
#undef HTTP_ONLY
...
/* Define fd_set structure */
typedef rtcs_fd_set fd_set;

/* Define hostent structure */
struct hostent {
...
#endif /* HEADER_CURL_CONFIG_MQX_H */
