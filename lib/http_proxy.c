  ...
  *done = FALSE;
  if(!ctx->cf_protocol) {
    ...
    case CURL_HTTP_VERSION_1_1:
      CURL_LOG_CF(data, cf, "installing subfilter for HTTP/1.1");
    ...
    case CURL_HTTP_VERSION_2:
      CURL_LOG_CF(data, cf, "installing subfilter for HTTP/2");
...
#endif
    default:
      CURL_LOG_CF(data, cf, "installing subfilter for default HTTP/1.1");
