                       ...
                       void *context)
{
  ...
  ret = EVP_DigestFinal_ex(*ctx,
                           tmp_digest, NULL) ? FETCHE_OK : FETCHE_SSL_CIPHER;
  if(ret == FETCHE_OK)
...
#define FETCH_PUT_64BIT_BE(ptr,val) do {                                 \
...
#define Wgen(w,t)                                                       \
    (fetch_uint64_t)( (w)[(t - 16) & 15] + sig1((w)[((t) - 2) & 15])     \
                       ...
                       void *context)
{
  ...
  FETCH_PUT_64BIT_BE(((unsigned char *) ctx_buf)  \
