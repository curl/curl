                                    ...
                                    bool *input_pending)
{
  ...
  *input_pending = FALSE;
  ...
  {
    quiche_transport_params qtstats;
    timediff_t idletime;
    uint64_t idle_ms = ctx->max_idle_ms;

    quiche_conn_peer_transport_params(ctx->qconn, &qtstats);
    if(qtstats.peer_max_idle_timeout && qtstats.peer_max_idle_timeout < idle_ms)
      idle_ms = qtstats.peer_max_idle_timeout;
