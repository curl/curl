...
struct curl_easyoption Curl_easyopts[] = {
  ...
  {"SSL_CACHE_DATA", CURLOPT_SSL_CACHE_DATA, CURLOT_CBPTR, 0},
  {"SSL_CACHE_FUNCTION", CURLOPT_SSL_CACHE_FUNCTION, CURLOT_FUNCTION, 0},
  {"SSL_SESS_DATA", CURLOPT_SSL_SESS_DATA, CURLOT_CBPTR, 0},
  {"SSL_SESS_FUNCTION", CURLOPT_SSL_SESS_FUNCTION, CURLOT_FUNCTION, 0},
