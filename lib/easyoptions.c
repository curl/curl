...
const struct curl_easyoption Curl_easyopts[] = {
  ...
  {"AWS_SIGV4_ALGORITHM", CURLOPT_AWS_SIGV4_ALGORITHM, CURLOT_STRING, 0},
  {"AWS_SIGV4_MODE", CURLOPT_AWS_SIGV4_MODE, CURLOT_STRING, 0},
  {"AWS_SIGV4_SIGNEDHEADERS", CURLOPT_AWS_SIGV4_SIGNEDHEADERS, CURLOT_STRING, 0},
