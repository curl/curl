...
/*
 * Fetch_auth_allowed_to_host() tells if authentication, cookies or other
...
void Fetch_auth_create_login_message(const char *value, struct bufref *out);

/* This is used to generate an EXTERNAL cleartext message */
void Fetch_auth_create_external_message(const char *user, struct bufref *out);
...
void Fetch_auth_gsasl_cleanup(struct gsasldata *digest);
#endif
...
FETCHcode Fetch_auth_create_oauth_bearer_message(const char *user,
                                                const char *host,
                                                const long port,
                                                const char *bearer,
                                                struct bufref *out);
...
FETCHcode Fetch_auth_create_xoauth_bearer_message(const char *user,
                                                 const char *bearer,
                                                 struct bufref *out);
