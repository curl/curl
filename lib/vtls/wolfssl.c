...
static const struct group_name_map gnm[] = {
  { .group = WOLFSSL_KYBER_LEVEL1, .name = "KYBER_LEVEL1" },
  { .group = WOLFSSL_KYBER_LEVEL3, .name = "KYBER_LEVEL3" },
  { .group = WOLFSSL_KYBER_LEVEL5, .name = "KYBER_LEVEL5" },
  { .group = WOLFSSL_NTRU_HPS_LEVEL1, .name = "NTRU_HPS_LEVEL1" },
  { .group = WOLFSSL_NTRU_HPS_LEVEL3, .name = "NTRU_HPS_LEVEL3" },
  { .group = WOLFSSL_NTRU_HPS_LEVEL5, .name = "NTRU_HPS_LEVEL5" },
  { .group = WOLFSSL_NTRU_HRSS_LEVEL3, .name = "NTRU_HRSS_LEVEL3" },
  { .group = WOLFSSL_SABER_LEVEL1, .name = "SABER_LEVEL1" },
  { .group = WOLFSSL_SABER_LEVEL3, .name = "SABER_LEVEL3" },
  { .group = WOLFSSL_SABER_LEVEL5, .name = "SABER_LEVEL5" },
  { .group = WOLFSSL_KYBER_90S_LEVEL1, .name = "KYBER_90S_LEVEL1" },
  { .group = WOLFSSL_KYBER_90S_LEVEL3, .name = "KYBER_90S_LEVEL3" },
  { .group = WOLFSSL_KYBER_90S_LEVEL5, .name = "KYBER_90S_LEVEL5" },
  { .group = WOLFSSL_P256_NTRU_HPS_LEVEL1, .name = "P256_NTRU_HPS_LEVEL1" },
  { .group = WOLFSSL_P384_NTRU_HPS_LEVEL3, .name = "P384_NTRU_HPS_LEVEL3" },
  { .group = WOLFSSL_P521_NTRU_HPS_LEVEL5, .name = "P521_NTRU_HPS_LEVEL5" },
  { .group = WOLFSSL_P384_NTRU_HRSS_LEVEL3, .name = "P384_NTRU_HRSS_LEVEL3" },
  { .group = WOLFSSL_P256_SABER_LEVEL1, .name = "P256_SABER_LEVEL1" },
  { .group = WOLFSSL_P384_SABER_LEVEL3, .name = "P384_SABER_LEVEL3" },
  { .group = WOLFSSL_P521_SABER_LEVEL5, .name = "P521_SABER_LEVEL5" },
  { .group = WOLFSSL_P256_KYBER_LEVEL1, .name = "P256_KYBER_LEVEL1" },
  { .group = WOLFSSL_P384_KYBER_LEVEL3, .name = "P384_KYBER_LEVEL3" },
  { .group = WOLFSSL_P521_KYBER_LEVEL5, .name = "P521_KYBER_LEVEL5" },
  { .group = WOLFSSL_P256_KYBER_90S_LEVEL1, .name = "P256_KYBER_90S_LEVEL1" },
  { .group = WOLFSSL_P384_KYBER_90S_LEVEL3, .name = "P384_KYBER_90S_LEVEL3" },
  { .group = WOLFSSL_P521_KYBER_90S_LEVEL5, .name = "P521_KYBER_90S_LEVEL5" },
  { .group = 0, .name = NULL }
};
#endif
