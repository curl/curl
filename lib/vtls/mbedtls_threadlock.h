...
#define Fetch_mbedtlsthreadlock_thread_setup() 1
#define Fetch_mbedtlsthreadlock_thread_cleanup() 1
#define Fetch_mbedtlsthreadlock_lock_function(x) 1
#define Fetch_mbedtlsthreadlock_unlock_function(x) 1
