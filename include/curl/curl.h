...
enum {
  SET_CURL_SSLVERSION_MAX(NONE,    0),
  SET_CURL_SSLVERSION_MAX(FIRST,   1),
  SET_CURL_SSLVERSION_MAX(TLSv1_0, 1),
  SET_CURL_SSLVERSION_MAX(TLSv1_1, 2),
  SET_CURL_SSLVERSION_MAX(TLSv1_2, 3),
