...
/* THis macro used to serve a purpose, kept for compatibility */
...
typedef enum {
  ...
  CURLSSLBACKEND_NSS = 3, /* deprecated since 8.3.0 */
  CURLSSLBACKEND_OBSOLETE4 = 4,  /* Was QSOSSL. */
  CURLSSLBACKEND_GSKIT = 5, /* deprecated since 8.3.0 */
  CURLSSLBACKEND_POLARSSL = 6, /* deprecated since 7.69.0 */
  CURLSSLBACKEND_WOLFSSL = 7,
  CURLSSLBACKEND_SCHANNEL = 8,
  CURLSSLBACKEND_SECURETRANSPORT = 9,
  CURLSSLBACKEND_AXTLS = 10, /* deprecated since 7.61.0 */
  CURLSSLBACKEND_MBEDTLS = 11,
  CURLSSLBACKEND_MESALINK = 12, /* deprecated since 7.82.0 */
...
typedef enum {
  ...
  /* deprecated since 7.56.0, Use CURLOPT_MIMEPOST" */
  ...
  /* HTTP PUT, deprecated since 7.12.1  */
