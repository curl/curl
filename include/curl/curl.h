...
enum {
  ...
  CURL_SET_SSLVERSION_MAX(TLSv1_0, 1),
  CURL_SET_SSLVERSION_MAX(TLSv1_1, 2),
  CURL_SET_SSLVERSION_MAX(TLSv1_2, 3),
  CURL_SET_SSLVERSION_MAX(TLSv1_3, 4),

  CURL_SET_SSLVERSION_MAX(LAST,    5), /* never use, keep last */
  CURL_SET_SSLVERSION_MAX(DEFAULT, 3)  /* = ..._OR_UP_TO_TLSv1_2 */
};
