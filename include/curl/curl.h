...
enum {
  ...
  CURL_SSLVERSION_MAX_TLSv1_0 =  (2 << 16),
  CURL_SSLVERSION_MAX_TLSv1_1 =  (3 << 16),
  CURL_SSLVERSION_MAX_TLSv1_2 =  (4 << 16),
  CURL_SSLVERSION_MAX_TLSv1_3 =  (5 << 16),

  CURL_SSLVERSION_MAX_LAST =     (6 << 16), /* never use, keep last */
};
