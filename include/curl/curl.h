...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* Extended header callback that receives origin information.
   * The callback signature is curl_write_callback_ex which includes
   * an unsigned int origin parameter using CURLH_* flags from header.h */
