...
#define FETCH_OFF_T_C(Val) FETCHINC_OFF_T_C_HLPR1(Val)##FETCHINC_OFF_T_C_HLPR1(FETCH_SUFFIX_FETCH_OFF_T)
#define FETCH_OFF_TU_C(Val) FETCHINC_OFF_T_C_HLPR1(Val)##FETCHINC_OFF_T_C_HLPR1(FETCH_SUFFIX_FETCH_OFF_TU)
#else
#ifdef FETCH_ISOCPP
