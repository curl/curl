![curl logo](https://www.curl.se/logo/curl-logo.svg)
...
page](https://www.curl.se/docs/manpage.html) or [the MANUAL
document](https://www.curl.se/docs/manual.html). Find out how to install Curl
by reading [the INSTALL document](https://www.curl.se/docs/install.html).

libcurl is the library curl is using to do its job. It is readily available to
be used by your software. Read [the libcurl.3 man
page](https://www.curl.se/libcurl/c/libcurl.html) to learn how!

You can find answers to the most frequent questions we get in [the FAQ
document](https://www.curl.se/docs/faq.html).

Study [the COPYING file](https://www.curl.se/docs/copyright.html) for
distribution terms.

## Contact

If you have problems, questions, ideas or suggestions, please contact us by
posting to a suitable [mailing list](https://www.curl.se/mail/).

All contributors to the project are listed in [the THANKS
document](https://www.curl.se/docs/thanks.html).

## Website

Visit the [curl website](https://www.curl.se/) for the latest news and
downloads.
