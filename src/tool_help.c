...
static const char *const helptext[] = {
  ...
  "     --false-start   Enable TLS False Start (SSL)",
  ...
  "     --http2         Use HTTP 2 (H)",
  "     --ignore-content-length  Ignore the HTTP Content-Length header (H)",
  ...
  "     --noproxy       List of hosts which do not use proxy (H)",
  ...
  " -x, --proxy [PROTOCOL://]HOST[:PORT]  Use proxy on given port (H)",
  ...
  " -U, --proxy-user USER[:PASSWORD]  Proxy user and password (H)",
  "     --proxy1.0 HOST[:PORT]  Use HTTP/1.0 proxy on given port (H)",
  " -p, --proxytunnel   Operate through a HTTP proxy tunnel (using CONNECT) (H)",
  ...
  " -X, --request COMMAND  Specify request command to use (H)",
