...
static const char *const helptext[] = {
  ...
  "     --up-to-tls-default   Use TLS up to recommended TLS version (SSL)",
  "     --up-to-tls-tlsv1.1   Use TLS up to TLSv1.1 (SSL)",
  "     --up-to-tls-tlsv1.2   Use TLS up to TLSv1.2 (SSL)",
  "     --up-to-tls-tlsv1.3   Use TLS up to TLSv1.3 (SSL)",
