...
static const struct writeoutvar variables[] = {
  ...
  { "http_auth_avail", VAR_HTTP_AUTH_AVAIL, CURLINFO_HTTPAUTH_AVAIL,
    writeLong },
  { "http_auth_used", VAR_HTTP_AUTH_USED, CURLINFO_HTTPAUTH_USED, writeLong },
  ...
  { "proxy_auth_avail", VAR_PROXY_AUTH_AVAIL, CURLINFO_PROXYAUTH_AVAIL,
    writeLong },
  { "proxy_auth_used", VAR_PROXY_AUTH_USED, CURLINFO_PROXYAUTH_USED,
    writeLong },
