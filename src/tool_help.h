...
#define CURLHELP_COMMON     (1 << 1)
#define CURLHELP_CONNECTION (1 << 2)
#define CURLHELP_CURL       (1 << 3)
#define CURLHELP_DEPRECATED (1 << 4)
#define CURLHELP_DNS        (1 << 5)
#define CURLHELP_FILE       (1 << 6)
#define CURLHELP_FTP        (1 << 7)
#define CURLHELP_GLOBAL     (1 << 8)
#define CURLHELP_HTTP       (1 << 9)
#define CURLHELP_IMAP       (1 << 10)
#define CURLHELP_IMPORTANT  (1 << 11)
#define CURLHELP_LDAP       (1 << 12)
#define CURLHELP_OUTPUT     (1 << 13)
#define CURLHELP_POP3       (1 << 14)
#define CURLHELP_POST       (1 << 15)
#define CURLHELP_PROXY      (1 << 16)
#define CURLHELP_SCP        (1 << 17)
#define CURLHELP_SFTP       (1 << 18)
