...
const struct helptxt helptext[] = {
  ...
  {"-d, --data <data>",
   "HTTP POST data",
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_HTTP | CURLHELP_POST |
   CURLHELP_UPLOAD},
  {"    --data-ascii <data>",
  ...
  {"-F, --form <name=content>",
   ...
   CURLHELP_COMMON | CURLHELP_HTTP | CURLHELP_UPLOAD | CURLHELP_POST |
  ...
  {"-I, --head",
   ...
   CURLHELP_COMMON | CURLHELP_HTTP | CURLHELP_FTP | CURLHELP_FILE},
  {"-H, --header <header/@file>",
   "Pass custom header(s) to server",
   CURLHELP_COMMON | CURLHELP_HTTP | CURLHELP_IMAP | CURLHELP_SMTP},
  {"-h, --help <subject>",
  ...
  {"-k, --insecure",
   ...
   CURLHELP_COMMON | CURLHELP_TLS | CURLHELP_SFTP | CURLHELP_SCP |
   CURLHELP_SSH},
  {"    --interface <name>",
  ...
  {"-m, --max-time <seconds>",
   ...
   CURLHELP_COMMON | CURLHELP_CONNECTION | CURLHELP_TIMEOUT},
  {"    --metalink",
  ...
  {"-o, --output <file>",
   ...
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_OUTPUT},
  {"    --output-dir <dir>",
  ...
  {"-x, --proxy <[protocol://]host[:port]>",
   "Use this proxy",
   CURLHELP_COMMON | CURLHELP_PROXY},
  {"    --proxy-anyauth",
  ...
  {"-X, --request <method>",
   ...
   CURLHELP_COMMON | CURLHELP_CONNECTION | CURLHELP_POP3 | CURLHELP_FTP |
   CURLHELP_IMAP | CURLHELP_SMTP},
  {"    --request-target <path>",
  ...
  {"-s, --silent",
   "Silent mode",
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_VERBOSE},
  {"    --skip-existing",
  ...
  {"    --trace-ascii <file>",
   ...
   CURLHELP_COMMON | CURLHELP_VERBOSE | CURLHELP_GLOBAL},
  {"    --trace-config <string>",
  ...
  {"-T, --upload-file <file>",
   ...
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_UPLOAD},
  {"    --upload-flags <flags>",
  ...
  {"-u, --user <user:password>",
   ...
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_AUTH},
  {"-A, --user-agent <name>",
   "Send User-Agent <name> to server",
   CURLHELP_COMMON | CURLHELP_IMPORTANT | CURLHELP_HTTP},
  ...
  {"-w, --write-out <format>",
   ...
   CURLHELP_COMMON | CURLHELP_VERBOSE},
  {"    --xattr",
