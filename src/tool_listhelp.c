...
const struct helptxt helptext[] = {
  ...
  {"    --proxy-ssl-auto-client-cert",
   ...
   CURLHELP_PROXY | CURLHELP_TLS},
  {"    --proxy-ssl-no-revoke",
   "Disable cert revocation checks for HTTPS proxy (Schannel)",
   CURLHELP_PROXY | CURLHELP_TLS},
  {"    --proxy-ssl-revoke-best-effort",
   "Ignore missing/offline cert CRL dist points for HTTPS proxy (Schannel)",
   CURLHELP_PROXY | CURLHELP_TLS},
