...
const struct helptxt helptext[] = {
  ...
  { "-C, --continue-at <offset>",
    ...
    CURLHELP_CONNECTION | CURLHELP_COMMON },
  ...
  { "-D, --dump-header <filename>",
    ...
    CURLHELP_HTTP | CURLHELP_FTP | CURLHELP_COMMON },
  { "    --ech <config>",
    "Configure ECH",
    CURLHELP_TLS },
  { "    --egd-file <file>",
  ...
  { "-I, --head",
    ...
    CURLHELP_HTTP | CURLHELP_FTP | CURLHELP_FILE | CURLHELP_COMMON },
  { "-H, --header <header/@file>",
    "Pass custom header(s) to server",
    CURLHELP_HTTP | CURLHELP_IMAP | CURLHELP_SMTP | CURLHELP_COMMON },
  { "-h, --help <subject>",
  ...
  { "-m, --max-time <seconds>",
    ...
    CURLHELP_CONNECTION | CURLHELP_TIMEOUT | CURLHELP_COMMON },
  { "    --metalink",
  ...
  { "-o, --output <file>",
    ...
    CURLHELP_IMPORTANT | CURLHELP_OUTPUT | CURLHELP_COMMON },
  { "    --output-dir <dir>",
  ...
  { "-x, --proxy <[protocol://]host[:port]>",
    "Use this proxy",
    CURLHELP_PROXY | CURLHELP_COMMON },
  { "    --proxy-anyauth",
  ...
  { "-s, --silent",
    "Silent mode",
    CURLHELP_IMPORTANT | CURLHELP_VERBOSE | CURLHELP_COMMON },
  { "    --skip-existing",
  ...
  { "    --trace-ascii <file>",
    ...
    CURLHELP_VERBOSE | CURLHELP_GLOBAL | CURLHELP_COMMON },
  { "    --trace-config <string>",
  ...
  { "-T, --upload-file <file>",
    ...
    CURLHELP_IMPORTANT | CURLHELP_UPLOAD | CURLHELP_COMMON },
  { "    --upload-flags <flags>",
  ...
  { "-u, --user <user:password>",
    ...
    CURLHELP_IMPORTANT | CURLHELP_AUTH | CURLHELP_COMMON },
  { "-A, --user-agent <name>",
    "Send User-Agent <name> to server",
    CURLHELP_IMPORTANT | CURLHELP_HTTP | CURLHELP_COMMON },
  ...
  { "-w, --write-out <format>",
    ...
    CURLHELP_VERBOSE | CURLHELP_COMMON },
  { "    --xattr",
