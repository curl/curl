...
const struct helptxt helptext[] = {
  ...
  {"    --aws-sigv4-algorithm <algorithm>",
   "AWS V4 signature algorithm",
   CURLHELP_AUTH | CURLHELP_HTTP},
  {"    --aws-sigv4-mode <mode>",
   "AWS V4 signature mode",
   CURLHELP_AUTH | CURLHELP_HTTP},
  {"    --aws-sigv4-signedheaders <list>",
   "AWS V4 signed headers list (semicolon delimited)",
   CURLHELP_AUTH | CURLHELP_HTTP},
  {"    --basic",
