...
struct LongShort {
  ...
  char letter;    /* short name option */
  char subletter; /* use OPT_SHORT when 'letter' is the short option */
};
...
static const struct LongShort aliases[]= {
  ...
  {"alpn",                     ARG_BOOL,     '*', 'H'},
  {"alt-svc",                  ARG_STRING,   'b', 'a'},
  {"anyauth",                  ARG_BOOL,     '*', 'o'},
  {"append",                   ARG_BOOL,     'a', OPT_SHORT},
  {"aws-sigv4",                ARG_STRING,   '*', 'V'},
  {"basic",                    ARG_BOOL,     '*', 'n'},
  {"buffer",                   ARG_BOOL,     'N', OPT_SHORT},
  {"ca-native",                ARG_BOOL,     'E', 'G'},
  {"cacert",                   ARG_FILENAME, 'E', 'a'},
  {"capath",                   ARG_FILENAME, 'E', 'g'},
  {"cert",                     ARG_FILENAME, 'E', OPT_SHORT},
  {"cert-status",              ARG_BOOL,     'E', 'q'},
  {"cert-type",                ARG_STRING,   'E', 'b'},
  {"ciphers",                  ARG_STRING,   '*', 'd'},
  {"clobber",                  ARG_BOOL,     'O', 'c'},
  {"compressed",               ARG_BOOL,     '*', 'j'},
  {"compressed-ssh",           ARG_BOOL,     '$', 'Z'},
  {"config",                   ARG_FILENAME, 'K', OPT_SHORT},
  {"connect-timeout",          ARG_STRING,   '*', 'c'},
  {"connect-to",               ARG_STRING,   '$', 'U'},
  {"continue-at",              ARG_STRING,   'C', OPT_SHORT},
  {"cookie",                   ARG_STRING,   'b', OPT_SHORT},
  {"cookie-jar",               ARG_STRING,   'c', OPT_SHORT},
  {"create-dirs",              ARG_BOOL,     '*', 'r'},
  {"create-file-mode",         ARG_STRING,   '*', 'R'},
  {"crlf",                     ARG_BOOL,     '*', 'u'},
  {"crlfile",                  ARG_FILENAME, 'E', 'j'},
  {"curves",                   ARG_STRING,   'E', 'E'},
  {"data",                     ARG_STRING,   'd', OPT_SHORT},
  {"data-ascii",               ARG_STRING,   'd', 'a'},
  {"data-binary",              ARG_STRING,   'd', 'b'},
  {"data-raw",                 ARG_STRING,   'd', 'r'},
  {"data-urlencode",           ARG_STRING,   'd', 'e'},
  {"delegation",               ARG_STRING,   '$', 'G'},
  {"digest",                   ARG_BOOL,     '*', 'k'},
  {"disable",                  ARG_BOOL,     'q', OPT_SHORT},
  ...
  {"doh-cert-status",          ARG_BOOL,     'E', 'Q'},
  {"doh-insecure",             ARG_BOOL,     'k', 'd'},
  {"doh-url"        ,          ARG_STRING,   '*', 'C'},
  {"dump-header",              ARG_FILENAME, 'D', OPT_SHORT},
  {"egd-file",                 ARG_STRING,   '*', 'b'},
  {"engine",                   ARG_STRING,   'E', 'f'},
  {"eprt",                     ARG_BOOL,     '*', 'Z'},
  {"epsv",                     ARG_BOOL,     '*', 'E'},
  {"etag-compare",             ARG_FILENAME, 'E', 'D'},
  {"etag-save",                ARG_FILENAME, 'E', 'C'},
  {"expect100-timeout",        ARG_STRING,   '$', 'R'},
  {"fail",                     ARG_BOOL,     'f', OPT_SHORT},
  {"fail-early",               ARG_BOOL,     'f', 'a'},
  {"fail-with-body",           ARG_BOOL,     'f', 'd'},
  {"false-start",              ARG_BOOL,     'E', 'r'},
  {"form",                     ARG_STRING,   'F', OPT_SHORT},
  {"form-escape",              ARG_BOOL,     '$', 'l'},
  {"form-string",              ARG_STRING,   'F', 's'},
  {"ftp-account",              ARG_STRING,   '$', 'm'},
  {"ftp-alternative-to-user",  ARG_STRING,   '$', 'u'},
  {"ftp-create-dirs",          ARG_BOOL,     '*', 'q'},
  {"ftp-method",               ARG_STRING,   '$', 'r'},
  {"ftp-pasv",                 ARG_BOOL,     '$', 'b'},
  {"ftp-port",                 ARG_STRING,   'P', OPT_SHORT},
  {"ftp-pret",                 ARG_BOOL,     '$', 'C'},
  ...
  {"get",                      ARG_BOOL,     'G', OPT_SHORT},
  {"globoff",                  ARG_BOOL,     'g', OPT_SHORT},
  {"happy-eyeballs-timeout-ms", ARG_STRING,  '$', '~'},
  {"haproxy-clientip",         ARG_STRING,   '*', 'P'},
  {"haproxy-protocol",         ARG_BOOL,     '*', 'X'},
  {"head",                     ARG_BOOL,     'I', OPT_SHORT},
  {"header",                   ARG_STRING,   'H', OPT_SHORT},
  {"help",                     ARG_BOOL,     'h', OPT_SHORT},
  {"hostpubmd5",               ARG_STRING,   'E', 'i'},
  {"hostpubsha256",            ARG_STRING,   'E', 'F'},
  {"hsts",                     ARG_STRING,   'b', 'b'},
  {"http0.9",                  ARG_BOOL,     '0', '9'},
  {"http1.0",                  ARG_NONE,     '0', OPT_SHORT},
  {"http1.1",                  ARG_NONE,     '0', '1'},
  {"http2",                    ARG_NONE,     '0', '2'},
  {"http2-prior-knowledge",    ARG_NONE,     '0', '3'},
  {"http3",                    ARG_NONE,     '0', '4'},
  {"http3-only",               ARG_NONE,     '0', '5'},
  {"ignore-content-length",    ARG_BOOL,     '$', 'p'},
  {"include",                  ARG_BOOL,     'i', OPT_SHORT},
  {"insecure",                 ARG_BOOL,     'k', OPT_SHORT},
  {"interface",                ARG_STRING,   '*', 'w'},
  {"ipfs-gateway",             ARG_STRING,   '*', 'S'},
  {"ipv4",                     ARG_NONE,     '4', OPT_SHORT},
  {"ipv6",                     ARG_NONE,     '6', OPT_SHORT},
  {"json",                     ARG_STRING,   'd', 'f'},
  {"junk-session-cookies",     ARG_BOOL,     'j', OPT_SHORT},
  {"keepalive",                ARG_BOOL,     '$', '1'},
  {"keepalive-time",           ARG_STRING,   '$', '3'},
  {"key",                      ARG_FILENAME, 'E', 'c'},
  {"key-type",                 ARG_STRING,   'E', 'd'},
  {"krb",                      ARG_STRING,   '*', 'x'},
  {"krb4",                     ARG_STRING,   '*', 'x'},
  {"libcurl",                  ARG_STRING,   '$', 'z'},
  {"limit-rate",               ARG_STRING,   '*', 'i'},
  {"list-only",                ARG_BOOL,     'l', OPT_SHORT},
  {"local-port",               ARG_STRING,   '$', 's'},
  {"location",                 ARG_BOOL,     'L', OPT_SHORT},
  {"location-trusted",         ARG_BOOL,     'L', 't'},
  {"login-options",            ARG_STRING,   'E', '5'},
  {"mail-auth",                ARG_STRING,   '$', 'H'},
  {"mail-from",                ARG_STRING,   '$', 'A'},
  {"mail-rcpt",                ARG_STRING,   '$', 'B'},
  {"mail-rcpt-allowfails",     ARG_BOOL,     'f', 'c'},
  {"manual",                   ARG_BOOL,     'M', OPT_SHORT},
  {"max-filesize",             ARG_STRING,   '*', 'y'},
  {"max-redirs",               ARG_STRING,   '*', 's'},
  {"max-time",                 ARG_STRING,   'm', OPT_SHORT},
  {"metalink",                 ARG_BOOL,     '$', 'J'},
  {"negotiate",                ARG_BOOL,     '*', 'l'},
  {"netrc",                    ARG_BOOL,     'n', OPT_SHORT},
  {"netrc-file",               ARG_FILENAME, 'n', 'e'},
  {"netrc-optional",           ARG_BOOL,     'n', 'o'},
  {"next",                     ARG_NONE,     ':', OPT_SHORT},
  {"noproxy",                  ARG_STRING,   '$', '5'},
  {"npn",                      ARG_BOOL,     '*', 'G'},
  {"ntlm",                     ARG_BOOL,     '*', 'm'},
  {"ntlm-wb",                  ARG_BOOL,     '*', 'M'},
  {"oauth2-bearer",            ARG_STRING,   '*', 'B'},
  {"output",                   ARG_FILENAME, 'o', OPT_SHORT},
  {"output-dir",               ARG_STRING,   'O', 'b'},
  {"parallel",                 ARG_BOOL,     'Z', OPT_SHORT},
  {"parallel-immediate",       ARG_BOOL,     'Z', 'c'},
  {"parallel-max",             ARG_STRING,   'Z', 'b'},
  {"pass",                     ARG_STRING,   'E', 'e'},
  {"path-as-is",               ARG_BOOL,     '$', 'N'},
  {"pinnedpubkey",             ARG_STRING,   'E', 'p'},
  {"post301",                  ARG_BOOL,     '$', '0'},
  {"post302",                  ARG_BOOL,     '$', '4'},
  {"post303",                  ARG_BOOL,     '$', 'I'},
  {"preproxy",                 ARG_STRING,   'x', 'a'},
  {"progress-bar",             ARG_BOOL,     '#', OPT_SHORT},
  {"progress-meter",           ARG_BOOL,     '#', 'm'},
  {"proto",                    ARG_STRING,   '$', 'D'},
  {"proto-default",            ARG_STRING,   '$', 'Q'},
  {"proto-redir",              ARG_STRING,   '$', 'E'},
  {"proxy",                    ARG_STRING,   'x', OPT_SHORT},
  {"proxy-anyauth",            ARG_BOOL,     '$', 'n'},
  {"proxy-basic",              ARG_BOOL,     '$', 'f'},
  {"proxy-ca-native",          ARG_BOOL,     'E', 'H'},
  {"proxy-cacert",             ARG_FILENAME, 'E', '6'},
  {"proxy-capath",             ARG_FILENAME, 'E', '7'},
  {"proxy-cert",               ARG_FILENAME, 'E', 'x'},
  {"proxy-cert-type",          ARG_STRING,   'E', 'y'},
  {"proxy-ciphers",            ARG_STRING,   'E', '2'},
  {"proxy-crlfile",            ARG_FILENAME, 'E', '3'},
  {"proxy-digest",             ARG_BOOL,     '$', 'e'},
  {"proxy-header",             ARG_STRING,   'H', 'p'},
  {"proxy-http2",              ARG_BOOL,     '0', 'a'},
  {"proxy-insecure",           ARG_BOOL,     'E', '8'},
  {"proxy-key",                ARG_FILENAME, 'E', 'z'},
  {"proxy-key-type",           ARG_STRING,   'E', '0'},
  {"proxy-negotiate",          ARG_BOOL,     '$', 'k'},
  {"proxy-ntlm",               ARG_BOOL,     '*', 't'},
  {"proxy-pass",               ARG_STRING,   'E', '1'},
  {"proxy-pinnedpubkey",       ARG_STRING,   'E', 'P'},
  {"proxy-service-name",       ARG_STRING,   '$', 'O'},
  {"proxy-ssl-allow-beast",    ARG_BOOL,     'E', '4'},
  {"proxy-ssl-auto-client-cert", ARG_BOOL,   'E', 'O'},
  {"proxy-tls13-ciphers",      ARG_STRING,   '1', 'B'},
  {"proxy-tlsauthtype",        ARG_STRING,   'E', 'w'},
  {"proxy-tlspassword",        ARG_STRING,   'E', 'v'},
  {"proxy-tlsuser",            ARG_STRING,   'E', 'u'},
  {"proxy-tlsv1",              ARG_NONE,     'E', '9'},
  {"proxy-user",               ARG_STRING,   'U', OPT_SHORT},
  {"proxy1.0",                 ARG_STRING,   '$', '8'},
  {"proxytunnel",              ARG_BOOL,     'p', OPT_SHORT},
  {"pubkey",                   ARG_STRING,   'E', 'h'},
  {"quote",                    ARG_STRING,   'Q', OPT_SHORT},
  {"random-file",              ARG_FILENAME, '*', 'a'},
  {"range",                    ARG_STRING,   'r', OPT_SHORT},
  {"rate",                     ARG_STRING,   '*', 'I'},
  {"raw",                      ARG_BOOL,     '$', '#'},
  {"referer",                  ARG_STRING,   'e', OPT_SHORT},
  {"remote-header-name",       ARG_BOOL,     'J', OPT_SHORT},
  {"remote-name",              ARG_BOOL,     'O', OPT_SHORT},
  {"remote-name-all",          ARG_BOOL,     'O', 'a'},
  {"remote-time",              ARG_BOOL,     'R', OPT_SHORT},
  {"remove-on-error",          ARG_BOOL,     'f', 'e'},
  {"request",                  ARG_STRING,   'X', OPT_SHORT},
  {"request-target",           ARG_STRING,   'G', 'a'},
  ...
  {"show-error",               ARG_BOOL,     'S', OPT_SHORT},
  {"silent",                   ARG_BOOL,     's', OPT_SHORT},
  {"socks4",                   ARG_STRING,   '$', 't'},
  {"socks4a",                  ARG_STRING,   '$', 'T'},
  {"socks5",                   ARG_STRING,   '$', 'c'},
  {"socks5-basic",             ARG_BOOL,     'E', 'A'},
  {"socks5-gssapi",            ARG_BOOL,     'E', 'B'},
  {"socks5-gssapi-nec",        ARG_BOOL,     '$', '7'},
  {"socks5-gssapi-service",    ARG_STRING,   '$', 'O'},
  {"socks5-hostname",          ARG_STRING,   '$', '2'},
  {"speed-limit",              ARG_STRING,   'Y', OPT_SHORT},
  {"speed-time",               ARG_STRING,   'y', OPT_SHORT},
  {"ssl",                      ARG_BOOL,     '$', 'a'},
  {"ssl-allow-beast",          ARG_BOOL,     'E', 'n'},
  {"ssl-auto-client-cert",     ARG_BOOL,     'E', 'o'},
  {"ssl-no-revoke",            ARG_BOOL,     'E', 's'},
  {"ssl-reqd",                 ARG_BOOL,     '$', 'v'},
  {"ssl-revoke-best-effort",   ARG_BOOL,     'E', 'S'},
  {"sslv2",                    ARG_NONE,     '2', OPT_SHORT},
  {"sslv3",                    ARG_NONE,     '3', OPT_SHORT},
  {"stderr",                   ARG_FILENAME, '*', 'v'},
  {"styled-output",            ARG_BOOL,     'f', 'b'},
  {"suppress-connect-headers", ARG_BOOL,     '$', 'Y'},
  {"tcp-fastopen",             ARG_BOOL,     'E', 't'},
  {"tcp-nodelay",              ARG_BOOL,     '$', 'd'},
  {"telnet-option",            ARG_STRING,   't', OPT_SHORT},
  {"test-event",               ARG_BOOL,     '$', 'L'},
  {"tftp-blksize",             ARG_STRING,   '$', '9'},
  {"tftp-no-options",          ARG_BOOL,     '$', 'S'},
  {"time-cond",                ARG_STRING,   'z', OPT_SHORT},
  {"tls-max",                  ARG_STRING,   '$', 'X'},
  {"tls13-ciphers",            ARG_STRING,   '1', 'A'},
  {"tlsauthtype",              ARG_STRING,   'E', 'm'},
  {"tlspassword",              ARG_STRING,   'E', 'l'},
  {"tlsuser",                  ARG_STRING,   'E', 'k'},
  {"tlsv1",                    ARG_NONE,     '1', OPT_SHORT},
  {"tlsv1.0",                  ARG_NONE,     '1', '0'},
  {"tlsv1.1",                  ARG_NONE,     '1', '1'},
  {"tlsv1.2",                  ARG_NONE,     '1', '2'},
  {"tlsv1.3",                  ARG_NONE,     '1', '3'},
  ...
  {"upload-file",              ARG_FILENAME, 'T', OPT_SHORT},
  {"url",                      ARG_STRING,   '*', '@'},
  {"url-query",                ARG_STRING,   'd', 'g'},
  {"use-ascii",                ARG_BOOL,     'B', OPT_SHORT},
  {"user",                     ARG_STRING,   'u', OPT_SHORT},
  {"user-agent",               ARG_STRING,   'A', OPT_SHORT},
  {"variable",                 ARG_STRING,   ':', 'a'},
  {"verbose",                  ARG_BOOL,     'v', OPT_SHORT},
  {"version",                  ARG_BOOL,     'V', OPT_SHORT},
#ifdef USE_WATT32
  {"wdebug",                   ARG_BOOL,     '*', 'p'},
#endif
  {"write-out",                ARG_STRING,   'w', OPT_SHORT},
  {"xattr",                    ARG_BOOL,     '*', '~'},
};
...
static const struct LongShort *single(char letter)
{
  ...
  if(!singles_done) {
    ...
    for(j = 0; j < sizeof(aliases)/sizeof(aliases[0]); j++) {
      if(aliases[j].subletter == OPT_SHORT) {
  ...
  *usedarg = FALSE; /* default is that we don't use the arg */
  ...
  do {
    ...
    case ONEOPT('#', 'm'): /* --progress-meter */
      ...
      break;
    case ONEOPT('#', OPT_SHORT): /* --progress-bar */
    ...
    case ONEOPT(':', 'a'): /* --variable */
      ...
      break;
    case ONEOPT(':', OPT_SHORT): /* --next */
      err = PARAM_NEXT_OPERATION;
      break;

    case ONEOPT('0', OPT_SHORT): /* --http1.0 */
      /* HTTP version 1.0 */
    ...
    case ONEOPT('1', 'B'): /* --proxy-tls13-ciphers */
      ...
      break;
    case ONEOPT('2', OPT_SHORT): /* --sslv2 */
      warnf(global, "Ignores instruction to use SSLv2");
      break;
    case ONEOPT('3', OPT_SHORT): /* --sslv3 */
      warnf(global, "Ignores instruction to use SSLv3");
      break;
    case ONEOPT('4', OPT_SHORT): /* --ipv4 */
      config->ip_version = CURL_IPRESOLVE_V4;
      break;
    case ONEOPT('6', OPT_SHORT): /* --ipv6 */
      config->ip_version = CURL_IPRESOLVE_V6;
      break;
    case ONEOPT('a', OPT_SHORT): /* --append */
      /* This makes the FTP sessions use APPE instead of STOR */
      config->ftp_append = toggle;
      break;
    case ONEOPT('A', OPT_SHORT): /* --user-agent */
    ...
    case ONEOPT('b', 'b'): /* --hsts */
      ...
      break;
    case ONEOPT('b', OPT_SHORT): /* --cookie */
      if(nextarg[0] == '@') {
        nextarg++;
      }
      ...
      break;
    case ONEOPT('B', OPT_SHORT): /* --use-ascii */
      config->use_ascii = toggle;
      break;
    case ONEOPT('c', OPT_SHORT): /* --cookie-jar */
      err = getstr(&config->cookiejar, nextarg, DENY_BLANK);
      break;
    case ONEOPT('C', OPT_SHORT): /* --continue-at */
    ...
    case ONEOPT('d', 'g'):  /* --url-query */
      ...
      break;
    case ONEOPT('D', OPT_SHORT): /* --dump-header */
      err = getstr(&config->headerfile, nextarg, DENY_BLANK);
      break;
    case ONEOPT('e', OPT_SHORT): { /* --referer */
    ...
    case ONEOPT('g', OPT_SHORT): /* --globoff */
      config->globoff = toggle;
      break;

    case ONEOPT('G', OPT_SHORT): /* --get */
    ...
    case ONEOPT('h', OPT_SHORT): /* --help */
      ...
      break;
    case ONEOPT('H', OPT_SHORT): /* --header */
    case ONEOPT('H', 'p'): /* --proxy-header */
      ...
      break;
    case ONEOPT('i', OPT_SHORT): /* --include */
      config->show_headers = toggle; /* show the headers as well in the
                                        general output stream */
      break;
    case ONEOPT('j', OPT_SHORT): /* --junk-session-cookies */
      config->cookiesession = toggle;
      break;
    case ONEOPT('I', OPT_SHORT): /* --head */
      ...
      if(SetHTTPrequest(config,
        ...
        err = PARAM_BAD_USE;
      break;
    case ONEOPT('J', OPT_SHORT): /* --remote-header-name */
      config->content_disposition = toggle;
      break;
    case ONEOPT('k', OPT_SHORT): /* --insecure */
      config->insecure_ok = toggle;
      break;
    case ONEOPT('k', 'd'): /* --doh-insecure */
      config->doh_insecure_ok = toggle;
      break;
    case ONEOPT('K', OPT_SHORT): /* --config */
      if(parseconfig(nextarg, global)) {
        errorf(global, "cannot read config from '%s'", nextarg);
        err = PARAM_READ_ERROR;
      }
      break;
    case ONEOPT('l', OPT_SHORT): /* --list-only */
      config->dirlistonly = toggle; /* only list the names of the FTP dir */
      break;
    case ONEOPT('L', OPT_SHORT): /* --location */
    case ONEOPT('L', 't'): /* --location-trusted */
      ...
      break;
    case ONEOPT('m', OPT_SHORT): /* --max-time */
      /* specified max time */
      err = secs2ms(&config->timeout_ms, nextarg);
      break;
    case ONEOPT('M', OPT_SHORT): /* --manual */
    ...
    case ONEOPT('o', OPT_SHORT): /* --output */
    case ONEOPT('O', OPT_SHORT): /* --remote-name */
      /* output file */
      if(!config->url_out)
      ...
      break;
    case ONEOPT('P', OPT_SHORT): /* --ftp-port */
      ...
      */
      ...
      break;
    case ONEOPT('p', OPT_SHORT): /* --proxytunnel */
      /* proxy tunnel for non-http protocols */
      config->proxytunnel = toggle;
      break;

    case ONEOPT('q', OPT_SHORT): /* --disable */
      /* if used first, already taken care of, we do it like this so we don't
         cause an error! */
      break;
    case ONEOPT('Q', OPT_SHORT): /* --quote */
    ...
    case ONEOPT('r', OPT_SHORT): /* --range */
      ...
      break;
    case ONEOPT('R', OPT_SHORT): /* --remote-time */
      /* use remote file's time */
      config->remote_time = toggle;
      break;
    case ONEOPT('s', OPT_SHORT): /* --silent */
      global->silent = toggle;
      break;
    case ONEOPT('S', OPT_SHORT): /* --show-error */
      global->showerror = toggle;
      break;
    case ONEOPT('t', OPT_SHORT): /* --telnet-option */
      /* Telnet options */
      err = add2list(&config->telnet_options, nextarg);
      break;
    case ONEOPT('T', OPT_SHORT): /* --upload */
      /* we are uploading */
      if(!config->url_ul)
    ...
    case ONEOPT('v', OPT_SHORT): /* --verbose */
      ...
      break;
    case ONEOPT('V', OPT_SHORT): /* --version */
      if(toggle)    /* --no-version yields no output! */
        err = PARAM_VERSION_INFO_REQUESTED;
      break;

    case ONEOPT('w', OPT_SHORT): /* --write-out */
    ...
    case ONEOPT('z', OPT_SHORT): /* --time-cond */
      switch(*nextarg) {
      case '+':
        nextarg++;
        FALLTHROUGH();
