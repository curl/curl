...
/* This is a simple example using libfetch's POP3 capabilities to list the
...
int main(void)
{
  ...
  if (fetch)
  {
    ...
    fetch_easy_setopt(fetch, FETCHOPT_URL, "pop3://pop.example.com");

    /* Set the UIDL command */
    fetch_easy_setopt(fetch, FETCHOPT_CUSTOMREQUEST, "UIDL");
