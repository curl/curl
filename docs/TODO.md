...
libcurl defaults to using binary WebSocket frames, which makes some server
implementastion simply not work as they require text. We should make it
possible to tell the tool to use text frames.
