...
[KNOWN_BUGS](https://www.curl.se/docs/knownbugs.html) page. Many of them link
...
On the [autobuilds page](https://www.curl.se/dev/builds.html) we show a
...
[TODO](https://www.curl.se/docs/todo.html) file. Some of the ideas are
...
We offer [guidelines](https://www.curl.se/dev/contribute.html) that are
