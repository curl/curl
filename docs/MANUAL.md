...
Fetch two files and store them with their remote names:
    ...
    curl -O www.haxx.se/index.html -O www.curl.se/download.html
...
Store the HTTP headers in a separate file (headers.txt in the example):
      ...
      curl --dump-header headers.txt www.curl.se
...
Format](https://www.curl.se/rfc/rfc2255.txt)
...
A very simple `.netrc` file could look something like:
    ...
    machine www.curl.se login iamdaniel password mysecret
