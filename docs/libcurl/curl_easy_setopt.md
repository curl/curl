...
## CURLOPT_AWS_SIGV4_ALGORITHM

AWS SigV4 algorithm. See CURLOPT_AWS_SIGV4_ALGORITHM(3)

## CURLOPT_AWS_SIGV4_MODE

AWS SigV4 signing mode. See CURLOPT_AWS_SIGV4_MODE(3)

## CURLOPT_AWS_SIGV4_SIGNEDHEADERS

AWS SigV4 signed headers list. See CURLOPT_AWS_SIGV4_SIGNEDHEADERS(3)
