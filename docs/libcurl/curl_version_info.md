...
libcurl was built to use c-ares for HTTPS resource record resolves, but uses
the threaded resolver for "normal" resolves (Added in 8.13.0)
...
libcurl was built with support for HTTPS resource records (Added in 8.13.0)
