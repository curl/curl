...
Initialize the socket libraries on platforms where such is necessary. Notably
on Windows when using Winsock.
...
A sensible default. It initializes both SSL and sockets (i.e. Winsock). Right
