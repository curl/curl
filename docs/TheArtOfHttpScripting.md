...
## See the Protocol
 ...
 Using curl's option [`--verbose`](https://www.curl.se/docs/manpage.html#-v)
 ...
 [`--trace`](https://www.curl.se/docs/manpage.html#-trace) and
 [`--trace-ascii`]((https://www.curl.se/docs/manpage.html#--trace-ascii)
...
## See the Timing
 ...
 [`--trace-time`]((https://www.curl.se/docs/manpage.html#--trace-time) option
...
## Spec
 ...
 https://www.curl.se or https://yourbank.com a million times. RFC 3986 is the
...
## Host
 ...
 [`--resolve`](https://www.curl.se/docs/manpage.html#--resolve) option:
...
## GET
 ...
 use curl's [`--include`](https://www.curl.se/docs/manpage.html#-i) (`-i`)
...
## HEAD
 ...
 [`--head`](https://www.curl.se/docs/manpage.html#-I) (`-I`) option which
...
## Multiple URLs in a single command line
 ...
 If you use [`--data`](https://www.curl.se/docs/manpage.html#-d) to POST to
...
## Multiple HTTP methods in a single command line
 ...
 [`--next`](https://www.curl.se/docs/manpage.html#-:) option. It is basically
...
## Other Authentication
 ...
 [`--ntlm`](https://www.curl.se/docs/manpage.html#--ntlm),
 [`--digest`](https://www.curl.se/docs/manpage.html#--digest),
 [`--negotiate`](https://www.curl.se/docs/manpage.html#--negotiate) or even
 [`--anyauth`](https://www.curl.se/docs/manpage.html#--anyauth) might be
...
## Proxy Authentication
 ...
 the Internet. To specify those with curl, run something like:
        ...
        curl --proxy-user proxyuser:proxypassword www.curl.se

 If your proxy requires the authentication to be done using the NTLM method,
 use [`--proxy-ntlm`](https://www.curl.se/docs/manpage.html#--proxy-ntlm), if
 it requires Digest use
 [`--proxy-digest`](https://www.curl.se/docs/manpage.html#--proxy-digest).
...
## Location header
 ...
 [`--location`](https://www.curl.se/docs/manpage.html#-L) (`-L`) and
...
## Cookie options
 ...
 using the [`--dump-header`](https://www.curl.se/docs/manpage.html#-D) (`-D`)
 option like:

    curl --dump-header headers_and_cookies http://www.example.com

 (Take note that the
 [`--cookie-jar`](https://www.curl.se/docs/manpage.html#-c) option described
 ...
 [`--cookie`](https://www.curl.se/docs/manpage.html#-b) option. If you only
...
## Certificates
 ...
 must then use [`--insecure`](https://www.curl.se/docs/manpage.html#-k)
 ...
 the [SSLCERTS document](https://www.curl.se/docs/sslcerts.html).
...
## More on changed methods
 ...
 [`--request`](https://www.curl.se/docs/manpage.html#-X) / `-X` option you
...
## Some debug tricks
 ...
 - Set user-agent (with [`-A`](https://www.curl.se/docs/manpage.html#-A)) to
   one like a recent popular browser does

 - Set referer (with [`-E`](https://www.curl.se/docs/manpage.html#-E)) like
