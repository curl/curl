...
Skip over to [https://www.curl.se/mail/](https://www.curl.se/mail/) and join
...
[mailing list etiquette](https://www.curl.se/mail/etiquette.html).
...
document](https://www.curl.se/dev/internals.html),
[TODO](https://www.curl.se/docs/todo.html),
[KNOWN_BUGS](https://www.curl.se/docs/knownbugs.html) and the [most recent
changes](https://www.curl.se/dev/sourceactivity.html) in git. Just lurking on
the [curl-library mailing
list](https://www.curl.se/mail/list.cgi?list=curl-library) will give you a
...
[CODE_STYLE](https://www.curl.se/dev/code-style.html) already established in
...
list](https://www.curl.se/mail/list.cgi?list=curl-library).
