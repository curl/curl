...
Build curl:
     ...
     % cd curl
     % autoreconf -fi
     % ./configure PKG_CONFIG_PATH=/path/to/gnutls/lib/pkgconfig:/path/to/ngtcp2/lib/pkgconfig --with-gnutls=/path/to/gnutls --with-nghttp3=/path/to/nghttp3 --with-ngtcp2
     % make
     % make install
